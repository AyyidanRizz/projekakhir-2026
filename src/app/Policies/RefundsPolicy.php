...
class RefundsPolicy
{
    ...
    {
        return $user->can('view_any_refunds');
    }
    ...
    {
        return $user->can('create_refunds');
    }
    ...
    {
        return $user->can('update_refunds');
    }
    ...
    {
        return $user->can('delete_refunds');
    }
    ...
    {
        return $user->can('delete_any_refunds');
    }
     ...
     */
    public function replicate(User $user, Refunds $refunds): bool
    {
