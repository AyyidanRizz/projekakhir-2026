...
@section('content')
		...
		<div class="untree_co-section">
			<div class="container">
				...
				<div class="row">
					...
					<div class="col-12 col-md-6 col-lg-3 mb-5 mb-md-0">
						<img src="{{ asset('front/images/person_1.jpg') }}" class="img-fluid mb-5">
            ...
            <p class="mb-0"><a href="#" class="more dark">Learn More <span class="icon-arrow_forward"></span></a></p>
					...
					<!-- Start Column 2 -->
					<div class="col-12 col-md-6 col-lg-3 mb-5 mb-md-0">
						<img src="{{ asset('front/images/person_2.jpg') }}" class="img-fluid mb-5">
            ...
            <p class="mb-0"><a href="#" class="more dark">Learn More <span class="icon-arrow_forward"></span></a></p>
					...
					<!-- Start Column 3 -->
					<div class="col-12 col-md-6 col-lg-3 mb-5 mb-md-0">
						<img src="{{ asset('front/images/person_3.jpg') }}" class="img-fluid mb-5">
            ...
            <p class="mb-0"><a href="#" class="more dark">Learn More <span class="icon-arrow_forward"></span></a></p>
					...
					<!-- Start Column 4 -->
					<div class="col-12 col-md-6 col-lg-3 mb-5 mb-md-0">
						<img src="{{ asset('front/images/person_4.jpg') }}" class="img-fluid mb-5">
